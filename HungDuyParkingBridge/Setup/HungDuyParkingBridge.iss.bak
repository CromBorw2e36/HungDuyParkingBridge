...
; Add the new startup entry (only if startup task is selected)
Root: HKLM; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; ValueName: "HungDuyParkingBridge"; ValueData: """{app}\{#MyAppExeName}"""; Flags: uninsdeletevalue; Tasks: startupicon
...
begin
  ...
  begin
    ...
    begin
      ...
      Log('Removed startup entry from HKLM: ' + Names[I]);
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      Log('Removed startup entry from HKCU: ' + Names[I]);
    end;
  end;
end;